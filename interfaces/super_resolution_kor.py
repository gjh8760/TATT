...
class TextSR(base.TextBase):
    ...
    def train(self):
        TP_Generator_dict = {'cdistnet': self.CDistNet_kor_init}
        ...
        cdistnet, cdistnet_info = self.CDistNet_kor_init()
        for p in cdistnet.parameters():
            p.requires_grad = False
        cdistnet.eval()
        test_bible['cdistnet_kor'] = {
            'model': cdistnet,
            'data_in_fn': self.parse_cdistnet_data,
            'string_process': get_string_cdistnet_kor
        }
    ...
    def test(self):
        TP_Generator_dict = {'cdistnet_kor': self.CDistNet_kor_init}
        recognizer_path = os.path.join(self.resume, 'recognizer_best.pth')
